...
def create_real_embeddings_cell():
    ...
    cell_source = [
        ...
        "\n",
        "# Get d_model for embedding dimension\n",
        ...
        "    \"\"\"\n",
        "    try:\n",
        "        # Tokenize sequence (RNATokenizer.encode requires max_len)\n",
        "        max_len = 512\n",
        "        tokens = tokenizer.encode(sequence, max_len=max_len)\n",
        "        \n",
        "        # Convert to tensor and add batch dimension\n",
        "        input_ids = tokens.unsqueeze(0).to(device)  # [1, max_len]\n",
        "        \n",
        "        # Get model output\n",
        "        with torch.no_grad():\n",
        ...
        "        embedding = extract_genesis_embedding(sequence, model, tokenizer, device, d_model)\n",
